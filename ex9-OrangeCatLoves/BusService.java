...
class BusService {
  ...
  public CompletableFuture<Set<BusStop>> getBusStops() {
    ...
    // BusAPI.getBusStopsServedBy(serviceId) returns a CompletableFuture instance.
    // Mapping of CompletableFuture instance.
    CompletableFuture<Set<BusStop>> result = BusAPI.getBusStopsServedBy(serviceId)
        .thenApply(value -> { 
